...
- [ ] Stage 1: Establish a characterization test suite.
...
- [ ] Stage 5: Deepen ticket persistence.
...
- [ ] Stage 6: Replace the CLI dispatcher with a command registry.
...
- [ ] Stage 7: Extract CLI command groups.
...
- [ ] Stage 8: Separate presentation from behavior.
...
- [ ] Stage 10: Consolidate application configuration.
...
- [ ] Stage 11: Broaden behavior coverage.
